...
# One-by-one training.
# ======================================================================================================================
class OboPRPRM(PRPRMBasic):
    def __init__(self, train, test, alpha_lambda, threshold, component_weight, cordi, n_user, n_item, n_size):
        super(OboPRPRM, self).__init__(train, test, alpha_lambda, threshold, component_weight, cordi, n_user,
                                      n_item, n_size)
